    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item layui-this"><a href="/admin/log/1">日志记录</a></li>
    ...
    <div class="layui-body" id="target_body" style="margin-left: 8px; margin-right: 8px;">
        <table class="layui-table">
            ...
            <tr>
                <td>贤心</td>
                <td>1</td>
                <td><span style="font-family: Georgia,serif" class="layui-badge-rim layui-bg-blue">61728</span></td>
                <td><span style="font-family: Georgia,serif" class="layui-badge-rim layui-bg-blue">61728</span></td>
                <td>
